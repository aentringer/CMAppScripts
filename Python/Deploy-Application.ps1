...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'python' -CloseAppsCountdown 900 -MinimizeWindows $false -PersistPrompt
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		## Show Welcome Message
		Show-InstallationWelcome -CloseApps 'python' -CloseAppsCountdown 300 -MinimizeWindows $false
