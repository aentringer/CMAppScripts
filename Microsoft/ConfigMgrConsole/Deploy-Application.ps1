...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'Microsoft.ConfigurationManagement' -CloseAppsCountdown 600 -MinimizeWindows $false
        ...
        Execute-Process -Path "$dirFiles\ConsoleSetup.exe" -Parameters '/q TargetDir="C:\Program Files (x86)\Microsoft Configuration Manager\AdminConsole" DefaultSiteServerName=YOURSITENAMEHERE'
