...
Try {
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Show-InstallationWelcome -CloseApps 'sqlops' -CloseAppsCountdown 600 -MinimizeWindows $false
        ...
        $installArgs = @(
            ...
            '/VERYSILENT'
            '/SUPPRESSMSGBOXES'
            "/LOG=`"C:\Windows\Temp\SQLOpsInstall-$(Get-Date -Format 'yyyy-MM-dd-hhmmss').log`""
            '/NORESTART'
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		## Show Welcome Message
		Show-InstallationWelcome -CloseApps 'sqlops' -CloseAppsCountdown 300 -MinimizeWindows $false
        ...
        $uninstallArgs = @(
            ...
            '/VERYSILENT'
            '/SUPPRESSMSGBOXES'
            "/LOG=`"C:\Windows\Temp\SQLOpsUninstall-$(Get-Date -Format 'yyyy-MM-dd-hhmmss').log`""
            '/NORESTART'
        )
		Execute-Process -Path "C:\Program Files\SQL Operations Studio\unins000.exe" -Parameters $uninstallArgs
